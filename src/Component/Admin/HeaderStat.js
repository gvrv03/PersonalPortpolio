...
const HeaderStat = () => {
  ...
  const StatHeader = () => {
    const HeaderCard = () => {
      return (
        <div className="">
          <div className="  px-5 py-5 bg-gray-100 flex gap-5 justify-center items-center dark:bg-gray-800 rounded-sm">
            <svg
              fill="none"
              stroke="currentColor"
              ...
              stroke-width="2"
              className="dark:text-red-600 text-indigo-500 w-12 h-12 mb-3 inline-block"
              viewBox="0 0 24 24"
            >
            ...
            <div className=" ">
              <h2 className="title-font font-medium  dark:text-gray-200 text-xl ">
                2.7K
              </h2>
              <p className="leading-relaxed text-sm dark:text-gray-200 ">
                Downloads
              </p>
            </div>
          </div>
  ...
  return (
    <div>
      <div className=" w-full  bg-white p-5 dark:bg-gray-900">
        {" "}
